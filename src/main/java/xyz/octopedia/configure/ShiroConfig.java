package xyz.octopedia.configure;

import xyz.octopedia.cache.RedisCacheManager;
import xyz.octopedia.filter.LoginFilter;
import xyz.octopedia.filter.PermissionFilter;
import xyz.octopedia.filter.RoleFilter;
import xyz.octopedia.security.MyPermissionResolver;
import xyz.octopedia.security.SysUserRealm;
import xyz.octopedia.session.RedisShiroSessionDao;
import xyz.octopedia.session.ShiroSessionFactory;
import xyz.octopedia.session.UserSessionManager;
